...
class WelcomeActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            WelcomeScreen(
                onStartClick = {
                    // TODO: Navigasi ke LoginActivity atau HomeActivity
...
fun WelcomeScreen(
    ...
    Box(
        ...
        Column(
            ...
            // Logo saja (tanpa tulisan D'Wacana)
            Image(
            ...
            Spacer(modifier = Modifier.height(20.dp)) // Jarak pendek agar lebih dekat dengan button
